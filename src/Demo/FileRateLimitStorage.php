 ...
 * there, same rationale as {@see \NeneInvoice\RecurringInvoice\FileRecurringRunThrottle}.
 *
 * Best-effort like that precedent: when the file cannot be opened or locked the
 * hit is counted as the first of a fresh window (fail-open) and logged — the
 * instance-wide org ceiling still bounds total growth. Stale files are pruned
 * by `tools/sweep-demo.php`.
 */
